...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="?mode=client" class="nav-link">Home</a>
      </li>
    </ul>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="?mode=admin&action=listComments" class="nav-link">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2025-2026 <a href="https://adminlte.io">keepsilent</a>.</strong>
    All rights reserved.
